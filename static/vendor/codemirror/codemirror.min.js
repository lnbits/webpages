!(function (e, t) {
  ...
  function We(e, t, n) {
    for (; (n < 0 ? 0 < t : t < e.length) && De(e.charAt(t)); ) t += n
    return t
  }
  function He(e, t, n) {
    for (var r = n < t ? -1 : 1; ; ) {
  ...
  function Pe(e, t, n) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      o.to == t && (o.from != o.to && 'before' == n ? (r = i) : (Fe = i)),
        o.from == t && (o.from != o.to && 'before' != n ? (r = i) : (Fe = i))
    }
    return null != r ? r : Fe
  }
  ;(Ee = /[\u0590-\u05f4\u0600-\u06ff\u0700-\u08ac]/),
    ...
    Ge = function (e, t) {
      ...
      return (
        'ltr' == t &&
          (1 == A[0].level &&
            (O = e.match(/^\s+/)) &&
            ((A[0].from = O[0].length), A.unshift(new Ue(0, 0, O[0].length))),
          1 == z(A).level &&
            (O = e.match(/\s+$/)) &&
            ((z(A).to -= O[0].length), A.push(new Ue(0, i - O[0].length, i)))),
        'rtl' == t ? A.reverse() : A
      )
    }
  function Ue(e, t, n) {
    ...
    k = function (e, t, n) {
      e.addEventListener
        ...
        : e.attachEvent
          ...
          : ((e = e._handlers || (e._handlers = {}))[t] = (e[t] || Ke).concat(
              n
            ))
    }
  function je(e, t) {
  ...
  function ut(e) {
    if ('string' == typeof e && at.hasOwnProperty(e)) e = at[e]
      ...
      var t = at[e.name]
      ;(e = ke((t = 'string' == typeof t ? {name: t} : t), e)).name = t.name
    } else {
  ...
  function Wt(n, r, e) {
    ...
    var o = (function (e, t, n) {
        for (
          ...
          if (
            u &&
            (!n || s + (u instanceof Nt ? u.lookAhead : 0) <= o.modeFrontier)
          )
            return s
  ...
  function Ht(e, t, n, r) {
    ...
    for (o.start = o.pos = r || 0, '' == t && Ft(i, n.state); !o.eol(); )
      Pt(i, o, n.state), (o.start = o.pos)
  }
  function Ft(e, t) {
    if (e.blankLine) return e.blankLine(t)
    if (e.innerMode)
      return (
        (e = pt(e, t)), e.mode.blankLine ? e.mode.blankLine(e.state) : void 0
      )
  }
  function Pt(e, t, n, r) {
    for (var i = 0; i < 10; i++) {
  ...
  ;(Ot.prototype.lookAhead = function (e) {
    ...
    (Ot.fromSaved = function (e, t, n) {
      return t instanceof Nt
        ? new Ot(e, ft(e.mode, t.state), n, t.lookAhead)
        : new Ot(e, ft(e.mode, t), n)
    }),
  ...
  function Rt(e, t, n, r) {
    ...
    for (r && (o = []); (r || c.pos < t.ch) && !c.eol(); )
      (c.start = c.pos),
        (i = Pt(s, c, u.state)),
        r && o.push(new Et(c, i, ft(l.mode, u.state)))
      ...
      var d,
        f =
          c.pos > e.options.maxHighlightLength
            ? ((s = !1), l && Ht(e, t, r, c.pos), (c.pos = t.length), null)
            : zt(Pt(n, c, r.state, h), o)
      if (
  ...
  function Kt(e, t) {
        ...
        if (e)
          for (var i = 0; i < e.length; ++i) {
            ...
            ;(!(
              ...
              (r = r || []).push(new Ut(s, l.from, o ? null : l.to)))
          }
        return r
      })(n, r, o),
      s = (function (e, t, n) {
          ...
          for (var i = 0; i < e.length; ++i) {
            ...
            ;(!(null == l.to || (s.inclusiveRight ? l.to >= t : l.to > t)) &&
              ...
              ((o =
                null == l.from || (s.inclusiveLeft ? l.from <= t : l.from < t)),
              (r = r || []).push(
                new Ut(s, o ? null : l.from - t, null == l.to ? null : l.to - t)
              ))
          }
        return r
      })(e, i, o),
    ...
    if (s)
      for (var f = 0; f < s.length; ++f) {
        ...
        null != p.to && (p.to += u),
          null == p.from
            ? Vt(l, p.marker) || ((p.from = u), a && (l = l || []).push(p))
    ...
    if (!a) {
      ...
      if (0 < v && l)
        for (var y = 0; y < l.length; ++y)
          null == l[y].to && (m = m || []).push(new Ut(l[y].marker, null, null))
            ...
            (function e(t, n, r) {
              {
                ...
                if (null == r.to)
                  return (
                    (i = r.marker.find(1, !0)),
                    e(t, i.line, Vt(i.line.markedSpans, r.marker))
                  )
              }
      ...
      !(function (e, t, n) {
        ...
        if (r)
          ...
          for (var O = 1; O < n.length; O += 2)
            t.addToken(t, i.slice(o, (o = n[O])), dn(n[O + 1], t.cm.options))
      })(o, r, Dt(e, o, l)),
        o.styleClasses &&
        ...
        for (var c = document.createDocumentFragment(), h = 0; ; ) {
          ...
          '\t' == d[0]
            ? ((f = (f = e.cm.options.tabSize) - (e.col % f)),
              (p = c.appendChild(M('span', Ce(f), 'cm-tab'))).setAttribute(
                'role',
                'presentation'
              ),
    ...
    if (n.length)
      for (
        var r,
          ...
          o =
            (bn
              ? (r = bn.delayedCallbacks)
              : wn
                ? (r = wn)
                : ((r = wn = []), setTimeout(xn, 0)),
            0);
        o < n.length;
        ++o
      )
      ...
      if ('text' == o) {
        ...
        s.text == s.node && (s.node = u.pre),
          ...
          u.bgClass != s.bgClass || u.textClass != s.textClass
            ? ((s.bgClass = u.bgClass), (s.textClass = u.textClass), kn(l, s))
  ...
  function Bn(e, t) {
    var n,
      ...
      e =
        (o && !o.text
          ? (o = null)
          : o && o.changes && (Cn(e, o, i, hr(e)), (e.curOp.forceUpdate = !0)),
        o ||
          ((e = e),
          (r = H((n = tn((n = t))))),
          ((n = e.display.externalMeasured = new vn(e.doc, n, r)).lineN = r),
          (r = n.built = fn(e, n)),
          (n.text = r.pre),
        ...
        if (3 == l.nodeType) {
          for (var c = 0; c < 4; c++) {
            ...
            for (
              ...
              De(t.line.text.charAt(o.coverStart + a));
  ...
  var Un,
    Vn = {left: 0, right: 0, top: 0, bottom: 0}
  function Kn(e, t, n) {
  ...
  function qn(e) {
    var t = tn(e).widgets,
      n = 0
    if (t) for (var r = 0; r < t.length; ++r) t[r].above && (n += On(t[r]))
    return n
  }
  function Zn(e, t, n, r, i) {
    if ((i || ((i = qn(t)), (n.top += i), (n.bottom += i)), 'line' == r))
      return n
    r = r || 'local'
    i = ln(t)
    return (
      'local' == r ? (i += Dn(e.display)) : (i -= e.display.viewOffset),
      ('page' != r && 'window' != r) ||
        ((i +=
          (t = e.display.lineSpace.getBoundingClientRect()).top +
          ('window' == r ? 0 : _n(ae(e)))),
        (t = t.left + ('window' == r ? 0 : $n(ae(e)))),
        (n.left += t),
        (n.right += t)),
      (n.top += i),
      (n.bottom += i),
  ...
  function tr(e, t) {
    var n = 0,
      t =
        ((t = E(e.doc, t)),
        e.options.lineWrapping || (n = cr(e.display) * t.ch),
        W(e.doc, t.line)),
      e = ln(t) + Dn(e.display)
  ...
  function rr(e, t, n) {
    ...
    for (var l = W(r, i); ; ) {
      var s = (function (n, e, t, r, i) {
          ...
          c &&
            ((c = (n.options.lineWrapping ? ar : sr)(n, e, t, o, c, r, i)),
            (u = 1 != c.level),
            (s = u ? c.from : c.to - 1),
            (a = u ? c.to : c.from - 1))
          var h = null,
            ...
            d
              ...
              : (u || (c != a && c != s) || c++,
                (g =
                  0 == c ||
                  (c != e.text.length &&
                    Gn(n, o, c - (u ? 1 : 0)).bottom + l <= i == u)
                    ? 'after'
                    : 'before'),
                (a = er(n, F(t, c, g), 'line', e, o)),
                (p = a.left),
  ...
  function ur(e) {
    ...
    if (null == Un) {
      ...
      for (var t = 0; t < 49; ++t)
        Un.appendChild(document.createTextNode('x')), Un.appendChild(M('br'))
  ...
  function gr(e, t, n, r) {
    ...
    return (
      r &&
        ...
        (i = F(
          i.line,
          Math.max(0, Math.round((o - Hn(e.display).left) / cr(e.display)) - n)
        ))),
      i
    )
  }
  ...
  function R(e, t, n, r) {
    ...
    var i,
      ...
      l =
        ...
        t >= o.viewTo
          ? Gt && nn(e.doc, t) < o.viewTo && yr(e)
          : n <= o.viewFrom
            ? Gt && rn(e.doc, n + r) > o.viewFrom
              ? yr(e)
  ...
  function br(e, t, n, r) {
    var i,
      o = mr(e, t),
      l = e.display.view
    if (!Gt || n == e.doc.first + e.doc.size) return {index: o, lineN: n}
  ...
  function Cr(e, t) {
    ...
    for (var s, a, u, c = 0; c < n.sel.ranges.length; c++)
      (!t && c == n.sel.primIndex) ||
        ...
        l
          ? (u = l(e, s)) && Sr(e, u, i)
          : (a || e.options.showCursorWhenSelecting) && Sr(e, s.head, i),
        a ||
          (function (i, e, t) {
            var n = i.display,
              o = i.doc,
  ...
  function Sr(e, t, n) {
    ...
    ;(i.style.left = r.left + 'px'),
      ...
      /\bcm-fat-cursor\b/.test(e.getWrapperElement().className) &&
        ((t = (t = Jn(e, t, 'div', null, null)).right - t.left),
    ...
    ;(e.state.delayingBlurEvent = !0),
      setTimeout(function () {
        e.state.delayingBlurEvent &&
          ((e.state.delayingBlurEvent = !1), e.state.focused && Or(e))
      }, 100)
  }
  function Nr(e, t) {
    e.state.delayingBlurEvent &&
  ...
  function Ar(e) {
    for (
      ...
      if (!s.hidden) {
        ...
        if (
          (0.005 < a || a < -0.005) &&
          (i < r && (o -= a), yt(s.line, u), Dr(s.line), s.rest)
        )
          for (var d = 0; d < s.rest.length; d++) Dr(s.rest[d])
        c > e.display.sizerWidth &&
          (a = Math.ceil(c / cr(e.display))) > e.display.maxLineLength &&
  ...
  function Wr(e, t, n) {
    ...
    return (
      n &&
        ...
        (n = n.ensure.to.line),
        r < i
          ? (o = bt(t, ln(W(t, (i = r))) + e.wrapper.clientHeight))
          : Math.min(n, t.lastLine()) >= o &&
            ((i = bt(t, ln(W(t, n)) - e.wrapper.clientHeight)), (o = n))),
  ...
  function Hr(e, t) {
    var n = e.display,
      ...
      l = {},
      s =
        (t.bottom - t.top > o && (t.bottom = t.top + o), e.doc.height + Wn(n)),
      a = t.top < r,
      r = t.bottom > s - r,
      r =
        (t.top < i
  ...
  function Rr(e) {
    ...
    t &&
      ...
      zr(e, tr(e, t.from), tr(e, t.to), t.margin))
  }
  function zr(e, t, n, r) {
    t = Hr(e, {
  ...
  function Ir(e, t) {
    Math.abs(e.doc.scrollTop - t) < 2 ||
      (d || ri(e, {top: t}), Br(e, t, !0), d && ri(e), Qr(e, 100))
  }
  function Br(e, t, n) {
    ;(t = Math.max(
      0,
  ...
  function jr(e, t) {
    ...
    for (
      ...
      n != e.display.barWidth && e.options.lineWrapping && Ar(e),
        Xr(e, Ur(e)),
  ...
  ;(Kr.prototype.update = function () {
    ...
    (Kr.prototype.setScrollLeft = function () {}),
    (Kr.prototype.setScrollTop = function () {}),
    (Kr.prototype.clear = function () {})
  var Yr = {native: Vr, null: Kr}
  function $r(n) {
    n.display.scrollbars &&
      ...
      (n.display.scrollbars = new Yr[n.options.scrollbarStyle](
        function (e) {
  ...
  function qr(e) {
    ;(e.curOp = {
      ...
      bn
        ? bn.ops.push(e)
        : (e.ownsGroup = bn = {ops: [e], delayedCallbacks: []})
  }
  function Zr(e) {
    e = e.curOp
    if (e) {
        ...
        for (var u = 0; u < n.length; u++) {
          ...
          ;(c.barMeasure = Ur(h)),
            d.maxLineChanged &&
              ...
              ((c.adjustWidthTo =
                zn(h, d.maxLine, d.maxLine.text.length).left + 3),
              ...
              (c.maxScrollLeft = Math.max(
                0,
                d.sizer.offsetLeft + c.adjustWidthTo - Pn(h)
              )))
              ...
              A(e, 'scrollCursorIntoView') ||
                ...
                null == r ||
                  ...
                  ((o = M(
                    ...
                    null,
                    'position: absolute;\n                         top: ' +
                      (t.top - n.viewOffset - Dn(e.display)) +
                      'px;\n                         height: ' +
  ...
  function Qr(e, t) {
    e.doc.highlightFrontier < e.display.viewTo &&
      e.state.highlight.set(t, de(Jr, e))
  }
  function Jr(l) {
    var s,
      a,
      ...
      c.iter(
        ...
        function (e) {
          if (a.line >= l.display.viewFrom) {
            ...
            e.text.length <= l.options.maxHighlightLength && Ht(l, e.text, a),
  ...
  function ti(e, t) {
    ...
    var i = r.first + r.size,
      ...
      i =
        ...
        i >= c.viewTo ||
        o <= c.viewFrom
          ? ((c.view = yn(l, i, o)), (c.viewFrom = i))
          : (c.viewFrom > i
              ? (c.view = yn(l, i, c.viewFrom).concat(c.view))
              : c.viewFrom < i && (c.view = c.view.slice(mr(l, i))),
            (c.viewFrom = i),
            c.viewTo < o
              ? (c.view = c.view.concat(yn(l, c.viewTo, o)))
              : c.viewTo > o && (c.view = c.view.slice(0, mr(l, o)))),
        (c.viewTo = o),
        (n.viewOffset = ln(W(e.doc, n.viewFrom))),
    ...
    var l = (function (e) {
        ...
        return (
          window.getSelection &&
            (t = he(e).getSelection()).anchorNode &&
            t.extend &&
    ...
    for (var g = c.view, m = c.viewFrom, v = 0; v < g.length; v++) {
      ...
      if (!y.hidden)
        if (y.node && y.node.parentNode == d) {
          ...
          y.changes &&
            (-1 < L(y.changes, 'gutter') && (b = !1), Cn(s, y, m, u)),
            b &&
              (te(y.lineNumber),
              y.lineNumber.appendChild(
                document.createTextNode(xt(s.options, m))
              )),
  ...
  function ni(e, t) {
    for (var n = t.viewport, r = !0; ; r = !1) {
      if (r && e.options.lineWrapping && t.oldDisplayWidth != Pn(e))
        r && (t.visible = Wr(e.display, e.doc, n))
      else if (
        (n &&
          null != n.top &&
          (n = {top: Math.min(e.doc.height + Wn(e.display) - En(e), n.top)}),
  ...
  function ri(e, t) {
    var n,
      t = new ei(e, t)
    ti(e, t) &&
      (Ar(e), ni(e, t), (n = Ur(e)), xr(e), jr(e, n), oi(e, n), t.finish())
  }
  function ii(e) {
  ...
  function li(e) {
    ...
    if (t.alignWidgets || (t.gutters.firstChild && e.options.fixedGutter)) {
      for (
        var r = dr(t) - t.scroller.scrollLeft + e.doc.scrollLeft,
  ...
  function si(e) {
    ...
    if (e.options.lineNumbers)
      return (
        (t = e.doc),
        (t = xt(e.options, t.first + t.size - 1)),
        (n = e.display),
  ...
  function hi(e, t, n, r) {
    ...
    ;(i.mover = M('div', [o], null, 'position: relative')),
      ...
      (i.heightForcer = M(
        ...
        null,
        null,
        'position: absolute; height: ' + ge + 'px; width: 1px;'
      )),
      ...
      (i.activeTouch = null),
      (i.gutterSpecs = ai(r.gutters, r.lineNumbers)),
      ui(i),
      n.init(i)
  }
    ...
    if ((r && s) || (n && a)) {
      ...
      if (r && !d && !K && null != i)
        return (
          ...
          Gr(e, Math.max(0, l.scrollLeft + r * i)),
          (n && !a) || D(t),
            ...
            ? ((o.wheelStartX = l.scrollLeft),
              ...
              setTimeout(function () {
                ...
                null != o.wheelStartX &&
                  ...
                  t && ((fi = (fi * di + t) / (di + 1)), ++di))
              }, 200))
            : ((o.wheelDX += r), (o.wheelDY += n)))
    }
  }
  w ? (fi = -0.53) : d ? (fi = 15) : m ? (fi = -0.7) : j && (fi = -1 / 3)
  var B = function (e, t) {
    ...
    G =
      ...
      (B.prototype.deepCopy = function () {
        for (var e = [], t = 0; t < this.ranges.length; t++)
          e[t] = new G(St(this.ranges[t].anchor), St(this.ranges[t].head))
        ...
        : h == d
          ? 1 == c.length
            ...
            : ((s = r(1, c.length - 1)).push(
                new un(f + h.text.slice(u.ch), p, l)
              ),
  ...
  function Di(e, t) {
    var n = {from: St(t.from), to: bi(t), text: mt(e, t.from, t.to)}
    return (
      Ei(e, n, t.from.line, t.to.line + 1),
      Mi(
        e,
        function (e) {
  ...
  function Hi(e, t, n, r) {
    ...
    if (
      ...
      var a = z(l.done)
      for (
        (a && a.ranges) || Pi(e.sel, l.done),
          o = {changes: [Di(e, t)], generation: l.generation},
          l.done.push(o);
  ...
  function Gi(e, t, n, r, i) {
    null == i && (i = e.cm && (e.cm.display.shift || e.extend)),
      U(e, new B([Bi(e.sel.primary(), t, n, i)], 0), r)
  }
  function Ui(e, t, n) {
    for (
      ...
      r[o] = Bi(e.sel.ranges[o], t[o], null, i)
  ...
  function Xi(e, t, n) {
    ;(Ye(e, 'beforeSelectionChange') ||
      ...
      (t = o.ranges != i.ranges ? vi(r.cm, o.ranges, o.ranges.length - 1) : i))
    var r,
      i,
      o =
        (n && n.bias) ||
  ...
  function no(e, n) {
    ...
    ;(1 == n.text.length && '' == n.text[0] && 0 == P(n.from, n.to)) ||
      ((t = xi(e, n)),
      Hi(e, n, t, e.cm ? e.cm.curOp.id : NaN),
      oo(e, n, t, Kt(e, n)),
      (r = []),
      Mi(e, function (e, t) {
        t || -1 != L(r, e.history) || (uo(e.history, n), r.push(e.history)),
          oo(e, n, null, Kt(e, n))
      }))
  }
  function ro(i, o, e) {
        ...
        for (
          var c = [],
            h =
              ...
              Ye(i, 'beforeChange') || (i.cm && Ye(i.cm, 'beforeChange'))),
          ...
          var f = (function (e) {
            ...
            var t = e ? xi(i, n) : z(s),
              r =
                (oo(i, n, t, zi(i, n)),
                !e && i.cm && i.cm.scrollIntoView({from: n.from, to: bi(n)}),
                [])
            Mi(i, function (e, t) {
              t ||
                -1 != L(r, e.history) ||
                (uo(e.history, n), r.push(e.history)),
                oo(e, n, null, zi(e, n))
            })
          })(d)
          if (f) return f.v
  ...
  function oo(e, t, n, r) {
    ...
    if (t.to.line < e.first)
      io(e, t.text.length - 1 - (t.to.line - t.from.line))
    else if (!(t.from.line > e.lastLine())) {
      t.from.line < e.first &&
        (io(e, (i = t.text.length - 1 - (e.first - t.from.line))),
        (t = {
          from: F(e.first, 0),
      ...
      if (
        ...
        var i = e.cm,
          ...
          f =
            ...
            -1 < s.sel.contains(o.from, o.to) && Xe(i),
            Ti(s, o, l, fr(i)),
            i.options.lineWrapping ||
        ...
        Qr(i, 400),
          ...
          o.full
            ? R(i)
            : u.line != c.line || 1 != o.text.length || ki(i.doc, o)
              ? R(i, u.line, c.line + 1, l)
              : vr(i, u.line, 'text'),
          (d = Ye(i, 'changes')),
          ((s = Ye(i, 'change')) || d) &&
            ((l = {
      ...
      Xi(e, n, ve),
        e.cantEdit && Zi(e, F(e.firstLine(), 0)) && (e.cantEdit = !1)
    }
  }
  function lo(e, t, n, r, i) {
    ...
    P((r = r || n), n) < 0 && ((n = (o = [r, n])[0]), (r = o[1])),
      ...
      to(e, {from: n, to: r, text: t, origin: i})
  }
  function so(e, t, n, r) {
    ...
    for (var i = 0; i < e.length; ++i) {
      ...
      if (o.ranges) {
        ...
        for (var s = 0; s < o.ranges.length; s++)
          so(o.ranges[s].anchor, t, n, r), so(o.ranges[s].head, t, n, r)
      } else {
  ...
  function co(e, t, n, r) {
    var i = t,
      o = t
    return (
      'number' == typeof t ? (o = W(e, Tt(e, t))) : (i = H(t)),
  ...
  ;(G.prototype.from = function () {
    ...
    (fo.prototype = {
      ...
      removeInner: function (e, t) {
        ...
        this.size - t < 25 &&
          (1 < this.children.length || !(this.children[0] instanceof ho)) &&
          (this.collapse((n = [])),
          (this.children = [new ho(n)]),
      ...
      maybeSpill: function () {
        if (!(this.children.length <= 10)) {
          ...
          do {
            var t,
              n = new fo(e.children.splice(e.children.length - 5, 5))
          } while (
            (e.parent
              ? ((e.size -= n.size),
                (e.height -= n.height),
              ...
              : ((((t = new fo(e.children)).parent = e).children = [t, n]),
                (e = t)),
            (n.parent = e.parent),
  ...
  function yo(r, i, o, e, t) {
    ...
    var d = new mo(r, t),
      f = P(i, o)
    if ((e && fe(e, d, !1), 0 < f || (0 == f && !1 !== d.clearWhenEmpty)))
      return d
    if (
      (d.replacedWith &&
        ((d.collapsed = !0),
    ...
    d.addToHistory && Hi(r, {from: i, to: o, origin: 'markText'}, r.sel, NaN)
    var p,
      g = i.line,
      m = r.cm
    if (
      (r.iter(g, o.line + 1, function (e) {
        ...
        m &&
          ...
          tn(e) == m.display.maxLine &&
          (p = !0),
          d.collapsed && g != i.line && yt(e, 0),
          (e = e),
          (t = new Ut(d, g == i.line ? i.ch : null, g == o.line ? o.ch : null)),
          (n =
            (n = r.cm && r.cm.curOp) &&
            window.WeakSet &&
      ...
      d.collapsed && ((d.id = ++vo), (d.atomic = !0)),
      m)
    ) {
  ...
  ;(mo.prototype.clear = function () {
    if (!this.explicitlyCleared) {
      ...
      null != r && t && this.collapsed && R(t, r, i + 1),
        (this.lines.length = 0),
        (this.explicitlyCleared = !0),
        this.atomic &&
          this.doc.cantEdit &&
          ((this.doc.cantEdit = !1), t && $i(t.doc)),
      ...
      r &&
        ...
        h(o, function () {
          var e = r.line,
            t = H(r.line),
            t = In(o, t)
          t && (jn(t), (o.curOp.selectionChanged = o.curOp.forceUpdate = !0)),
            (o.curOp.updateMaxLine = !0),
            on(i.doc, e) ||
              null == i.height ||
              ((t = i.height),
              (i.height = null),
              (t = On(i) - t) && yt(e, e.height + t)),
  ...
  function f(e, t, n, r, i) {
    ...
    null == n && (n = 0),
      fo.call(this, [new ho([new un('', null)])]),
      (this.first = n),
      ...
      Ti(this, {from: n, to: n, text: e}),
      U(this, yi(n), ve)
  }
  var Co = 0,
    So =
      (((f.prototype = ke(fo.prototype, {
        constructor: f,
        iter: function (e, t, n) {
          n
        ...
        clearHistory: function () {
          var t = this
          ;(this.history = new Ai(this.history)),
            Mi(
              this,
              function (e) {
        ...
        clearGutter: n(function (t) {
          ...
          this.iter(function (e) {
            e.gutterMarkers &&
              e.gutterMarkers[t] &&
              co(n, e, 'gutter', function () {
                return (
                  (e.gutterMarkers[t] = null),
                  Oe(e.gutterMarkers) && (e.gutterMarkers = null),
                  1
                )
              })
          })
        ...
        linkedDoc: function (e) {
          for (
            ...
            var l = i[o],
              ...
              s = r.clipPos(s.to)
            P(a, s) &&
              ((a = yo(r, a, s, l.primary, l.primary.type)),
              l.markers.push(a),
              (a.parent = l))
          }
          return n
            ...
            if (c) {
              if (
                ...
                for (var h = 0; h < u.length; ++h)
                  lo(r.doc, '', u[h].anchor, u[h].head, 'drag')
  ...
  function Uo(t, e) {
    ...
    h(t, function () {
      for (var e = r.length - 1; 0 <= e; e--)
        lo(t.doc, '', r[e].from, r[e].to, '+delete')
      Pr(t)
    })
  }
  function Vo(e, t, n) {
  ...
  ;(Fo.basic = {
    ...
    (Fo.default = C ? Fo.macDefault : Fo.pcDefault)
  var Yo = {
    selectAll: Ji,
  ...
  function Jo(e, t, n, r) {
    r = (function (e, t, n) {
      ...
      return (
        (e.options.extraKeys && Ro(t, e.options.extraKeys, n, e)) ||
        Ro(t, e.options.keyMap, n, e)
      )
    })(e, t, r)
    return (
      'multi' == r && (e.state.keySeq = t),
      'handled' == r && b(e, 'keyHandled', e, t, n),
      ('handled' != r && 'multi' != r) || (D(n), kr(e)),
      !!r
    )
  }
  function el(t, e) {
          ...
          (r = t
            ? ((i = t),
              ...
              sl && sl.compare(r, i, o)
                ? ((ll = sl = null), 'triple')
                : ll && ll.compare(r, i, o)
                  ? ((sl = new ol(r, i, o)), (ll = null), 'double')
                  : ((ll = new ol(r, i, o)), (sl = null), 'single'))
            : 'single'),
          he(c).focus(),
            ...
            (1 == n
              ? t
                ? ((i = c),
                  ...
                  (l = r),
                  (s = e),
                  w ? setTimeout(de(Tr, i), 0) : (i.curOp.focus = N(ue(i))),
                  (a = (function (e, t, n) {
                  ...
                  (i.options.dragDrop &&
                        ...
                        var o = t.display,
                          ...
                          s = I(t, function (e) {
                            x && (o.scroller.draggable = !1),
                              ...
                              l ||
                                (D(e),
                                i.addNew || Gi(t.doc, r, null, null, i.extend),
                                (x && !j) || (w && 9 == v)
                                  ? setTimeout(function () {
                    ...
                    : function (d, e, f, p) {
                        ...
                        'rectangle' == p.unit
                          ...
                          : ((e = ul(d, f, p.unit)),
                            (m = p.extend
                              ? Bi(m, e.anchor, e.head, p.extend)
                              : e))
                        p.addNew
                          ? -1 == v
                            ? ((v = t.length),
                              U(g, vi(d, t.concat([m]), v), {
                                scroll: !1,
                                origin: '*mouse'
                              }))
                            : 1 < t.length &&
                            ...
                            if (((b = e), 'rectangle' == p.unit)) {
                              for (
                                ...
                                o == l
                                  ...
                                  : u.length > c &&
                                    t.push(new G(F(s, c), F(s, we(u, l, n))))
                              }
                              t.length || t.push(new G(f, f)),
                                U(g, vi(d, y.ranges.slice(0, v).concat(t), v), {
                                  origin: '*mouse',
                                  scroll: !1
                                }),
                                d.scrollIntoView(e)
                              ...
                              var h,
                                ...
                                e =
                                  0 < P(i.anchor, e)
                                    ? ((h = i.head), kt(r.from(), i.anchor))
                                    : ((h = i.anchor), Lt(r.to(), i.head)),
                                r = y.ranges.slice(0)
                              ;(r[v] = (function (e, t) {
                                var n = t.anchor,
                                  r = t.head,
              ...
              : 2 == n
                ...
                : 3 == n && (Q ? c.display.input.onContextMenu(e) : Mr(c)))))
  }
  function ul(e, t, n) {
  ...
  function cl(e, t, n, r) {
    ...
    for (var s = 0; s < e.display.gutterSpecs.length; ++s) {
      ...
      if (a && a.getBoundingClientRect().right >= i)
        return (
          O(e, n, e, bt(e.doc, o), e.display.gutterSpecs[s].className, t), qe(t)
        )
    }
  }
  function hl(e, t) {
  ...
  function dl(e, t) {
    ...
    An(e.display, t) ||
      ((r = t),
      Ye((n = e), 'gutterContextMenu') && cl(n, r, 'gutterContextMenu', !1)) ||
      A(e, t, 'contextmenu') ||
      Q ||
  ...
  function yl(e) {
    e.options.lineWrapping
      ...
      : (ee(e.display.wrapper, 'CodeMirror-wrap'), an(e)),
      pr(e),
      R(e),
      Yn(e),
      setTimeout(function () {
  ...
  function p(e, t) {
        ...
        w && v < 11
          ? I(l, function (e) {
              ...
              A(l, e) ||
                ...
                hl(l, e) ||
                An(l.display, e) ||
                (D(e), (e = l.findWordAt(t)), Gi(l.doc, e.anchor, e.head))
            })
          : function (e) {
              return A(l, e) || D(e)
            }
    ...
    k(s.scroller, 'touchstart', function (e) {
      ...
      (s.dragFunctions = {
        ...
        over: function (e) {
          ...
          A(l, e) ||
            ((n = gr((t = l), (n = e))) &&
              (Sr(t, n, (n = document.createDocumentFragment())),
        ...
        start: function (e) {
          ...
          ;(t = l),
            (e = e),
            w && (!t.state.draggingText || +new Date() - So < 100)
              ? Ze(e)
              : A(t, e) ||
                An(t.display, e) ||
    ...
    (t.autofocus && !_) || this.hasFocus()
      ...
      : Or(this),
    ml))
      ml.hasOwnProperty(r) && ml[r](this, t[r], pl)
  ...
  function wl(e, t, n, r) {
    ...
    if (r || /\S/.test(s.text)) {
      if (
        'smart' == n &&
        ((c = o.mode.indent(i, s.text.slice(u.length), s.text)) == me ||
          150 < c)
      ) {
        if (!r) return
        n = 'prev'
    ...
    if ((d < c && (h += Ce(c - d)), h != u))
      return lo(o, h, F(t, 0), F(t, u.length), '+input'), !(s.stateAfter = null)
    ...
    if (s && 1 < r.ranges.length)
      if (xl && xl.text.join('\n') == t) {
        if (r.ranges.length % xl.text.length == 0)
          for (var u = [], c = 0; c < xl.text.length; c++)
            u.push(o.splitLines(xl.text[c]))
      } else
    ...
    for (
      'page' == r
        ? ((i = Math.min(
            ...
            he(e).innerHeight || s(e).documentElement.clientHeight
          )),
          (i = Math.max(i - 0.5 * ur(e.display), 3)),
  ...
  function Hl(e, t, n) {
    ...
    if (t == e.display.lineDiv) {
      if (!(r = e.display.lineDiv.childNodes[n]))
        return Wl(e.clipPos(F(e.display.viewTo - 1)), !0)
      ;(t = null), (n = 0)
    } else
      ...
      if (o.node == r) {
        ...
        if (o == s)
          if (((a = !0), (o = s.childNodes[l]), (l = 0), !o))
            return Wl(F(H((c = u.rest ? z(u.rest) : u.line)), c.text.length), a)
  ...
  ;(r.prototype.init = function (e) {
    ...
    (r.prototype.focus = function () {
      'nocursor' != this.cm.options.readOnly &&
        ((this.selectionInEditor() && N(ce(this.div)) == this.div) ||
    ...
    (r.prototype.pollSelection = function () {
      if (
        ...
        this.composing ||
          (this.rememberSelection(),
          (e = Hl(r, n.anchorNode, n.anchorOffset)),
          (t = Hl(r, n.focusNode, n.focusOffset)),
          e &&
            t &&
            h(r, function () {
              U(r.doc, yi(e, t), ve),
    ...
    (r.prototype.pollContent = function () {
      ...
      var o,
        l =
          i.line == n.viewFrom || 0 == (l = mr(t, i.line))
      ...
      for (
        var s = t.doc.splitLines(
          ...
          a = mt(t.doc, F(e, 0), F(o, W(t.doc, o).text.length));
  ...
  ;(i.prototype.init = function (n) {
    ...
    function t(e) {
      if (!A(i, e)) {
        if (i.somethingSelected()) Cl({lineWise: !1, text: i.getSelections()})
        else {
          if (!i.options.lineWiseCopyCut) return
          var t = Tl(i)
          Cl({lineWise: !0, text: t.text}),
            'cut' == e.type
              ? i.setSelections(t.ranges, null, ve)
    ...
    (i.prototype.focus = function () {
      if (
        'nocursor' != this.cm.options.readOnly &&
        (!_ || N(ce(this.textarea)) != this.textarea)
      )
        try {
          this.textarea.focus()
        } catch (e) {}
    ...
    o('lineSeparator', null, function (e, r) {
      if ((e.doc.lineSep = r)) {
        ...
        for (var t = i.length - 1; 0 <= t; t--)
          lo(e.doc, r, i[t], F(i[t].line, i[t].ch + r.length))
      }
    }),
    o(
      'specialChars',
    ...
    o(
      ...
      !0,
      function (e, t) {
        ;(e.display.gutters.style.left = t ? dr(e.display) + 'px' : '0'),
          e.refresh()
      },
      !0
    ),
    ...
    o('cursorHeight', 1, xr, !0),
    o('singleCursorHeightPerLine', !0, xr, !0),
    o('workTime', 100),
    o('workDelay', 100),
    o('flattenSpans', !0, Li, !0),
    o('addModeClass', !1, Li, !0),
    o('pollInterval', 100),
    ...
    (El.prototype = {
      ...
      setOption: function (e, t) {
        ...
        ;(n[e] == t && 'mode' != e) ||
          ((n[e] = t),
          Rl.hasOwnProperty(e) && I(this, Rl[e])(this, t, r),
      ...
      removeOverlay: t(function (e) {
        for (var t = this.state.overlays, n = 0; n < t.length; ++n) {
          ...
          if (r == e || ('string' == typeof e && r.name == e))
            return t.splice(n, 1), this.state.modeGen++, void R(this)
        }
      }),
        ...
        for (var t = this.doc.sel.ranges, n = -1, r = 0; r < t.length; r++) {
          ...
          if (i.empty())
            i.head.line > n &&
              ...
              (n = i.head.line),
              r == this.doc.sel.primIndex && Pr(this))
          else {
            for (
              var o = i.from(),
                i = i.to(),
            ...
            0 == o.ch &&
              t.length == i.length &&
              0 < i[r].from().ch &&
              Vi(this.doc, r, new G(o, i[r].to()), ve)
          }
        }
      }),
      ...
      getStateAfter: function (e, t) {
        ...
        return Wt(
          this,
          (e = Tt(n, null == e ? n.first + n.size - 1 : e)) + 1,
          t
        ).state
      },
        ...
        var r = !1,
          i =
            'number' == typeof e
              ...
              : e
        return (
          Zn(this, i, {top: 0, left: 0}, t || 'page', n || r).top +
          (r ? this.doc.height - ln(i) : 0)
        )
      },
      ...
      addWidget: function (e, t, n, r, i) {
        ...
        ;(t.style.position = 'absolute'),
          ...
          n &&
            ...
            null != (l = Hr(r, l)).scrollTop && Ir(r, l.scrollTop),
            null != l.scrollLeft && Gr(r, l.scrollLeft))
      },
      ...
      findPosH: function (e, t, n, r) {
        for (
          ...
          l < t && !(o = Ol(this.doc, o, i, n, r)).hitSide;
          ++l
        );
        return o
      },
      moveH: t(function (t, n) {
        ...
        this.extendSelectionsBy(function (e) {
          return r.display.shift || r.doc.extend || e.empty()
            ? Ol(r.doc, e.head, t, n, r.options.rtlMoveVisually)
            : t < 0
              ? e.from()
              : e.to()
        }, be)
      ...
      scrollIntoView: t(function (e, t) {
        ...
        null == e
          ...
          (e.margin = t || 0),
          null != e.from.line
            ? ((t = e), Rr((n = this)), (n.curOp.scrollToPos = t))
            : zr(this, e.from, e.to, e.margin)
      }),
      setSize: t(function (e, t) {
        ...
        var r = this,
          i =
            ...
            this.options.lineWrapping && Xn(this),
      ...
      refresh: t(function () {
        ...
        R(this),
          ...
          ii(this.display),
          (null == e ||
            0.5 < Math.abs(e - ur(this.display)) ||
    ...
    $e(El),
    (El.registerHelper = function (e, t, n) {
      zl.hasOwnProperty(e) || (zl[e] = El[e] = {_global: []}), (zl[e][t] = n)
    }),
    (El.registerGlobalHelper = function (e, t, n, r) {
      El.registerHelper(e, t, r), zl[e]._global.push({pred: n, val: r})
    })
  var Il,
    Bl = 'iter insert remove copy getEditor constructor'.split(' ')
